...
import { createSpec, allSpecifications, getSpecs, updateSpec, deleteItem, deleteSpec, generateUniqueNumber } from '../controllers/specController.js';
...
specRouter.route('/generateUniqueNumber').get(authenticate, generateUniqueNumber);
