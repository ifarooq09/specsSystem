    ...
    const fetchDirectorates = async () => {
      try {
        ...
        if (!res.ok) {
          ...
          setTotalDirectorates(data.length)
        }
      } catch (error) {
        console.error("Error fetching users:", error.message)
        setErrorMessage("An error occurred while fetching directorates.")
      } finally {
        setIsLoading(false);
      }
    }

    fetchDirectorates() // Call the function once within useEffect
